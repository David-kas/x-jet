...
> = {
  ru: {
    home: {
      title: (_p) => "Лаки Джет (Lucky Jet) — как найти официальный сайт 1win, Ракетка Тамаева",
      desc: (_p) =>
        "Лаки Джет официальный сайт: как найти страницу 1win. Lucky Jet, Ракетка Тамаева, игра, демо, скачать, стратегия, сигналы и вывод денег — обзор 2026.",
    },
    demo: {
