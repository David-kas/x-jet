...
> = {
  ru: {
    home: {
      title: (_p) => "Лаки Джет (Lucky Jet) — 1win, Ракетка Тамаева, официальный сайт и игра",
      desc: (_p) =>
        "Лаки Джет (Lucky Jet): официальный сайт 1win, игра, демо, скачать, стратегия, сигналы, Ракетка Тамаева и вывод денег. Обзор 2026.",
    },
    demo: {
